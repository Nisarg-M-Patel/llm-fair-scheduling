...
from vidur.scheduler.replica_scheduler.vtc_replica_scheduler import VTCReplicaScheduler
from vidur.scheduler.replica_scheduler.vtc_sarathi_replica_scheduler import (
    VTCSarathiReplicaScheduler,
)
...
ReplicaSchedulerRegistry.register(
    ReplicaSchedulerType.VTC, VTCReplicaScheduler
)
ReplicaSchedulerRegistry.register(
    ReplicaSchedulerType.VTC_SARATHI, VTCSarathiReplicaScheduler
)

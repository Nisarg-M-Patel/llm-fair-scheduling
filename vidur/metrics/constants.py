...
class ClientCompletionMetricsTimeSeries(enum.Enum):
    CLIENT_ZERO_SERVICE_RECEIVED = "client_zero_service_received"
    CLIENT_ONE_SERVICE_RECEIVED = "client_one_service_received"

...
PREFILL_SERVICE_COST_MULTIPLIER = 1
DECODE_SERVICE_COST_MULTIPLIER = 2
...
class Request(BaseEntity):
    def __init__(
        ...
        self._service_cost = self._get_service_cost()
    ...
    def get_prefill_token_service_cost(self, num_tokens: int) -> float:
        """

...
from vidur.request_generator.client_assignment_generator_registry import (
    ClientAssignmentGeneratorRegistry,
)
...
class SyntheticRequestGenerator(BaseRequestGenerator):
    ...
    def __init__(self, config: SyntheticRequestGeneratorConfig):
        ...
        self.client_assignment_generator = ClientAssignmentGeneratorRegistry.get(
            self.config.client_assignment_generator_config.get_type(),
            self.config.client_assignment_generator_config,
        )
    ...
    def _generate_next_request(self, last_arrived_at: float) -> Request:
        ...
        client_id = self.client_assignment_generator.get_next_client_id()
